    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link
            href="/karts"
            className="inline-block px-6 py-3 bg-red-600 text-white font-medium hover:bg-red-700 transition-colors duration-200 rounded-lg"
          >
            Browse All Products
          </Link>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative bg-zinc-50 rounded-2xl overflow-hidden">
                ...
                <div className="absolute top-4 left-4 z-10">
                  <span className="px-3 py-1.5 bg-white/90 backdrop-blur-sm text-red-700 text-xs font-medium rounded-full shadow-sm">
                    {product.skinType}
                  </span>
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              {isInCart(product._id) && (
                <div className="mb-2">
                  <button
                    ...
                    className="text-left text-sm text-red-600 hover:text-red-700 font-medium hover:underline decoration-red-300 hover:decoration-red-500 transition-all cursor-pointer duration-200 font-outfit"
                  >
                    Remove from Cart
                  </button>
                </div>
              ...
              {isInCart(product._id) ? (
                <button
                  disabled
                  className="w-full text-center px-4 py-3 bg-red-300 cursor-not-allowed text-white font-medium text-sm rounded-[5px] font-outfit flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
                ...
                <button
                  ...
                  className="w-full text-center px-4 py-3 bg-red-600 text-white font-medium cursor-pointer hover:bg-red-700 transition-all duration-300 text-sm rounded-[5px] font-outfit transform hover:scale-[1.02]"
                >
                  Add to Cart
                </button>
              )}
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`flex-1 inline-flex items-center justify-center px-4 py-3 border text-sm rounded-[5px] font-outfit transition-all duration-300 ${
                    isInWishlist(product._id)
                      ...
                      : "border-zinc-300 text-zinc-700 hover:border-red-300 hover:text-red-600 hover:bg-red-50 hover:scale-[1.02]"
                  }`}
                >
                  <svg
                ...
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center px-4 py-3 bg-transparent border-2 border-red-600 text-red-600 font-medium hover:bg-red-50 hover:border-red-700 hover:text-red-700 transition-all duration-300 text-sm rounded-[5px] font-outfit gap-2 hover:scale-[1.02]"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
            ...
            <div className="flex overflow-x-scroll snap-x snap-proximity gap-4 pb-4">
              {relatedProducts.map((relatedProduct) => (
                <Link
                  ...
                  href={`/karts/${relatedProduct._id}`}
                  className="group snap-start flex-shrink-0"
                >
                  <div className="bg-white border border-zinc-200 hover:border-red-300 transition-all duration-300 flex flex-col rounded-[5px] shadow-sm hover:shadow-lg transform hover:-translate-y-1 w-[280px] sm:w-[320px]">
                    {/* Image Container */}
                    ...
                    <div className="p-4 flex flex-col flex-grow">
                      ...
                      <h3 className="text-base font-semibold text-zinc-900 mb-2 line-clamp-2 group-hover:text-red-700 transition-colors duration-300">
                        {relatedProduct.name}
                      </h3>
