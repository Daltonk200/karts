    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <div className="absolute inset-0">
          <Image
            src="https://images.unsplash.com/photo-1612892483236-52d32a0e0ac1?w=1200&q=80"
            alt="Racing Kart"
            fill
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12 w-full">
          <div className="max-w-md text-center space-y-6">
            ...
            <h2 className="text-4xl font-bold font-caveat">
              Join Apex Rush Today
            </h2>
            <p className="text-lg text-white/90 font-outfit">
              Create your account and start your racing journey. Get access to exclusive deals, track your orders, and join our racing community.
            </p>
            <div className="space-y-3 pt-4">
              <div className="flex items-center justify-center space-x-3 text-left">
                ...
                <span className="text-white/90 font-outfit">Exclusive member discounts</span>
              </div>
              <div className="flex items-center justify-center space-x-3 text-left">
                <svg className="w-6 h-6 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-white/90 font-outfit">Fast order tracking</span>
              </div>
              <div className="flex items-center justify-center space-x-3 text-left">
                <svg className="w-6 h-6 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-white/90 font-outfit">Priority customer support</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2 font-outfit">
                Sign up to get started with Apex Rush
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="terms" className="text-gray-700 font-outfit">
                    I agree to the{" "}
                    <Link
                      href="/terms"
